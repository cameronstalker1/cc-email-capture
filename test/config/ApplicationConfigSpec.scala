...
class ApplicationConfigSpec extends UnitSpec with FakeCCEmailApplication {
  ...
  "ApplicationConfig" should {
    ...
    "verify configuration" in {
      ApplicationConfig.ccEmailCollection shouldBe "Email"
      ApplicationConfig.csiRegistrationCollection shouldBe "registration"
    }
    ...
    "contain correct configuration for sending emails" in {
      ...
      ApplicationConfig.mailTemplate shouldBe "childcare_registration_email"
    }
